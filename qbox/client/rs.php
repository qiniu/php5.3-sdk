...
/**
 * func PutFileWithCRC32(url, key, mimeType, localFile, customMeta, callbackParams string, crc32CheckEnable boolean) => (data PutRet, code int, err Error)
 * 匿名上传一个文件(上传用的临时 url 通过 $rs->PutAuth 得到)
 */
function PutFileWithCRC32($url, $tblName, $key, $mimeType, $localFile, $customMeta = '', $callbackParams = '', $crc32CheckEnable = false) {
